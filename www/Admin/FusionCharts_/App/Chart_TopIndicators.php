...
<table width='875' align='center' cellspacing='0' cellpadding='0'>
	...
	<td align='center'>
	<?php	
	$strXML  = "<chart caption='Top 5 Most Expensive Products' PYAxisName='Unit Price' SYAxisName='Units Sold for the year' palette='" . getPalette() . "' animation='" . getAnimationState() . "' formatNumberScale='0' numberPrefix='$' seriesNameInToolTip='0' sNumberSuffix=' pcs.' showValues='0' plotSpacePercent='0'>";
